...
<h1>TABLEAU DE BORD DES INDICATEURS DE PERFORMANCE</h1>


<!-- Formulaire de recherche -->
<form method="post" action="index.php" class="do">
...
echo "<tr><th>PRODUIT	
</th><th>Réalisation Périodique</th><th>Taux de Réalisation Périodique (%)</th><th>Taux de Réalisation Annuelle (%)</th></tr>";

// Affichage des données pour la table table_cm_ligne_tel_objectif
echo "<tr><td>LIGNE TLP [PSTN]	
</td><td>$realisation_periodique</td><td>$taux_realisation_periodique1%</td><td>$taux_realisation_annuelle1%</td></tr>";

// Affichage des données pour la table table_cm_ftth_objectif
echo "<tr><td>ACCES [FTTH]	
</td><td>$realisation_periodique_ftth</td><td>$taux_realisation_periodique2%</td><td>$taux_realisation_annuelle2%</td></tr>";

// Affichage des données pour la table table_cm_adsl_objectif
echo "<tr><td>ACCES [ADSL]	
</td><td>$realisation_periodique_adsl</td><td>$taux_realisation_periodique3%</td><td>$taux_realisation_annuelle3%</td></tr>";

// Affichage des données pour la table table_cm_4g_lte_objectif
echo "<tr><td>ACCES 4G LTE	
</td><td>$realisation_periodique_4g_lte</td><td>$taux_realisation_periodique4%</td><td>$taux_realisation_annuelle4%</td></tr>";
...
echo "<tr><th>PRODUIT	
</th><th>CHIFFRE D'AFFAIRE DE LA PERIODE</th><th>TAUX ANNUEL </th></tr>";
echo "<tr><td>INTERNET [4G LTE]	
</td>><td>$realisation_periodique_4g</td><td>$taux_realisation_annuelle_internet_4g%</td></tr>";
echo "<tr><td>INTERNET [ADSL+FTTH]	
</td><td>$realisation_periodique_filaire</td><td>$taux_realisation_annuelle_internet_filaire%</td></tr>";
echo "<tr><td>TOTAL INTERNET[4GLTE+ADSL+FTTH]	
</td><td>$realisation_periodique_internet_total</td><td>$taux_realisation_annuelle_internet_total%</td></tr>";
echo "<tr><td>TELEPHONIE [TLP]	
</td><td>$realisation_periodique_telephone</td><td>$taux_realisation_annuelle_tel%</td></tr>";
echo "<tr><td>TOTAL[TLP+INTERNET]	
</td><td>$realisation_periodique_total</td><td>$taux_realisation_annuelle_total%</td></tr>";
echo "</table>";
